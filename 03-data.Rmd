...
```{r stacspec, echo=FALSE, fig.cap = "SpatioTemporal Asset Catalogs [(STAC; stacspec.org)](https://stacspec.org/) aims to provide a common specification to enable online search and discovery of geospatial assets in just about any format.", fig.width=3, fig.align = 'center', out.width="100%"}
knitr::include_graphics("img/stacspec.png")
```

<br>

Last, but not least, and not necessarily related to metadata, but it does make metadata capture easier, I strongly recommend you read this short paper on **[how to keep your data Tidy](http://dx.doi.org/10.18637/jss.v059.i10)** [@Wickham2014]. It will life it much easier for you once you get to the analysis step...
...
There are some other aspects of data, while still important if the goal is purely academic, that are make-or-break when the goal is informing decisions. 
