...
> _Just a quick acknowledgement that I have borrowed and adapted much of the following from Michael Dietze's [**Pair coding practical**](https://github.com/EcoForecast/EF_Activities/blob/master/Exercise_04_PairCoding.Rmd) that is a living online supplement to his book [@Dietze2017]. Thanks for sharing the code under an MIT license Mike!_
