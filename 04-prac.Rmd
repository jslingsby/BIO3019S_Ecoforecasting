...
(Along the way we will also be exploring the statistical concept of Likelihood?).
...
<br>
- Develop framework to fit models and make plots
- Questions about residuals etc etc
- Compare recovery trajectories across multiple sites?
- Compare recovery trajectories within sites, between 2000 and 2015 fires...
<br>
