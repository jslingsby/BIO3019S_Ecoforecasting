...
## Proteaceae as a model organisms
...
Our knowledge of the demography of the Proteaceae is used for the direct management of Fynbos in two ways:

- Firstly, at the _species level_, for setting guidelines for **sustainable wild harvesting** of their inflorescences
- Secondly, at the _ecosystem level_, to help determine **acceptable fire return intervals**
...
## Protea demography and issues with the rules of thumb

**First a quick refresher on Proteaceae life cycles and demography:**
...
But is that enough? So what should the harvesting guidelines be? Are we sure they would be effective and what if there are "ecological surprises" that make them inappropriate? For example, @Treurnicht2021 did not consider changing climate or fire regimes? Should we just ban wildflower harvesting altogether to be safe?

While it isn't a huge industry, a ban would be undesirable for a number of reasons:
...
- while some species may struggle under the existing guidelines, others are largely unaffected
...
They modeled the species' individual vital rates as a function of environmental variation across its range (Figure \@ref(fig:merow2014vitalrates)) and then combined them to estimate the population growth rates $\lambda$ per pixel. This provided an indication of where the population should remain stable or increase ($\lambda>1$) or decline and go extinct ($\lambda<1$), and was used as a threshold to map the species' distribution (Figure \@ref(fig:merow2014lambda)).
...
a. can tell us where we are most likely to see a negative response 
