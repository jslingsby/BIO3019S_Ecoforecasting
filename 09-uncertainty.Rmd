...
- because they're **highly uncertain**, which requies you: 
...
## Propogating and partitioning uncertainty in the impacts of invasive alien plants on streamflow
...
While Glenn is adamant that these differences aren't the result of Jensen's Inequality, I thought it worth flagging Jensen's inequality since (a) it's likely to trip youup one day, and (b) I find it to be another good reason why we should always estimate things with uncertainty!
