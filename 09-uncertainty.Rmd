...
- because they're **highly sensitive**, requiring you to perform:
  - **sensitivity analysis**
    - You'll cover these in more detal in the module on matrix models. I'm not going to go into them here, but they focus on **how a change in X translates into a change in Y**. The bigger the relative change in Y, the more sensitive.
