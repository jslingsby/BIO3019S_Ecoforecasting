...
Note that there are quite a few different versions of the data life cycle out there. This is the most comprehensive one I know of and covers all the steps relevent to a range of different kinds of research projects. Not all projects need to do all steps, nor will they necessarily follow the order here, but it is worth being aware of and considering all steps.
...
#### Plan 
Good data management begins with planning. While constructing Data Management Plans (DMPs) can seem tedious, they are essential:

a. for the reasons I gave above
b. because most funders and universities now require them

Fortunately, there are a number of online data management planning tools, including [UCT's DMP Tool](https://dmp.lib.uct.ac.za/), that now make it easy, by providing templates and prompts to ensure that you cover all the bases.
...
While "Collect" and "Assure" are different steps in the life cycle, I advocate that it is foolish to collect data without doing quality assurance and quality control (QA/QC) as you go. 
