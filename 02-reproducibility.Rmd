...
(see https://www.earthdatascience.org/slide-shows/1_intro-reprod-science/#11 for a different way to slice the pie...)
...
- Careful documentation of hardware and versions of software used in analyses 
- Containers
