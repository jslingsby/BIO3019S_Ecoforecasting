...
::: incremental
1.  They _**focus on estimating what properties are**_
...
2.  They are highly _**flexible**_, allowing _**complex models with varied data sources**_, especially Hierarchical Bayesian models
3.  They can _**treat all terms as probability distributions**_, making it easier to quantify, propagate and partition uncertainties throughout the analysis, allowing one to:
    -   **present uncertainty** in the forecast to the decision maker
    -   **analyze the uncertainty**, guiding improvements
4.  They provide an _**iterative**_ probabilistic framework that allows us to learn from new evidence (data) in the context of existing (*prior*) knowledge.
