...
This is a big topic in itself and has a separate section in my notes. I encourage you to **_read the notes_** as this is NB information for you to know, and the content is still be examinable, although I will not expect you to know it in as much detail.
...
## 1. Data management - Plan {.smaller background-color="#33431e"}
...
- [FigShare](https://figshare.com/), [Zenodo](https://zenodo.org/), UCT's [ZivaHub](https://zivahub.uct.ac.za/) (based on FigShare)
:::
::::
