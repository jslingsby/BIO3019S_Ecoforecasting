...
::: {.column width="45%"}
A plant growth model from [Higgins et al. 2023 *Science*](http://dx.doi.org/10.1126/science.add5190)

The relationships between parameters are defined mechanistically, based on known equations, but the parameters themselves are estimated statistically from empirical data.
:::
...
Mechanistic general ecosystem models (GEMs), e.g. [Hoeks et al 2021 **GEB**](https://doi.org/10.1111/geb.13354)
