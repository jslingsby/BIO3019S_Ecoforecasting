...
\path (0,-1.5)node{{\it Fitted directly to data}};
...
Quantitative biology is more than just modeling. A large part is developing the necessary tools and approaches for managing and manipulating large and varied datasets.
