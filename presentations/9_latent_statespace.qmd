...
## Latent variables and state-space models {.smaller background-color="#c2c190"}
...
## Random observation error {background-color="#c2c190"}


## Systematic observation error {background-color="#c2c190"}

Where the bias is constant, it can often be corrected with an offset, e.g.
